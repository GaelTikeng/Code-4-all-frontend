...
export default function Footer({ }: Props) {
  ...
  return (
    <div className="bg-[#0a191c] py-10">
      <div className="text-white md:px-[80px] px-[20px] md:flex gap-4">
        <div className="flex flex-col w-1/4 leading-8">
          <Image
            src="/code4all.png"
            alt="logo"
            height={60}
            ...
            priority={false}
          />
          <Link href="#" className="hover:underline hover:text-[#f94d1c]">Privacy Policy</Link>
          <Link href="#" className="hover:underline hover:text-[#f94d1c]">Terms and Conditions</Link>
          <Link href="#" className="hover:underline hover:text-[#f94d1c]">Lorem ipsum dolor sit amet consectetur ?</Link>
        </div>
        <div className="flex flex-col w-1/4 leading-8">
          <h2>
            INFORMATION
